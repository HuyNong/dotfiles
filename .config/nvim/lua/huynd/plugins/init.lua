return {
    ...
    },
    {
        "mbbill/undotree",
        config = function()
            vim.keymap.set("n", "<leader>ud", vim.cmd.UndotreeToggle, { desc = "Undotree toggle", silent = true })
        end,
    },
    {
        "stevearc/oil.nvim",
    ...
    },
    {
        ...
        config = function()
            vim.keymap.set("n", "<leader>tf", "<CMD>FloatermNew --height=0.8 --width=0.8 --wintype=float --name=terminal --position=center<CR>", { desc = "Term: New float terminal" })
